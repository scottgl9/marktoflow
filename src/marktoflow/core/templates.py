"""Workflow template library for marktoflow framework.
...
def create_template_registry(
    ...
    if project_root:
        # .marktoflow/templates directory
        marktoflow_templates = project_root / ".marktoflow" / "templates"
        if marktoflow_templates.exists():
            template_dirs.append(marktoflow_templates)
